...
public class Demo {
	...
	//generating super class object
     ...
     String mgrdata=m.toString(); //manager is calling super class employee to string() , manger is calling own class overrided method toString()
     System.out.println(mgrdata);
     
     String engdata=en.toString(); //engineer is calling super class employee to string(), engineer calling own class overrided method toString()
